...
struct device_node {
	const char *name;  //设备树里有name 这个属性时，属性值即为 name 的值， 没有name 属性时，为NULL
	const char *type;  //来自设备树节点中的device_type属性，如果没有该属性，则为“NULL”
	phandle phandle;
	const char *full_name;  //节点的名字， node-name[@unit-address]
	struct fwnode_handle fwnode;

	struct	property *properties;  //节点的属性    		属性是一个链表，有一个或者多个属性通过链表链接在一起
